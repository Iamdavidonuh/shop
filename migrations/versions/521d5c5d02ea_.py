...
Revision ID: 521d5c5d02ea
Revises: 
Create Date: 2018-12-04 20:26:26.510008
...
def upgrade():
    ...
    op.create_index(op.f('ix_admin_firstname'), 'admin', ['firstname'], unique=True)
    op.create_index(op.f('ix_admin_lastname'), 'admin', ['lastname'], unique=True)
    op.create_index(op.f('ix_admin_phonenumber'), 'admin', ['phonenumber'], unique=True)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_admin_phonenumber'), table_name='admin')
    op.drop_index(op.f('ix_admin_lastname'), table_name='admin')
    op.drop_index(op.f('ix_admin_firstname'), table_name='admin')
